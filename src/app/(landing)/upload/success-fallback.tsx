...
export default function SuccessFallback() {
    return (
        <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-bg-primary to-bg-accent p-4">
            <motion.div
            ...
            >
                ...
                <div className="flex gap-4 mt-8 w-full justify-center">
                    <Link href="/profile" className="bg-accent text-white px-6 py-2 rounded-lg font-bold shadow hover:bg-highlight transition-colors duration-200 text-center min-w-[8rem]">
                        Go To Profile
                    </Link>
